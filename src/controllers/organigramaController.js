...
const { list, save,save_invitado,edit,update,eliminar_invitados, insert_path,buscar_invitados } = require('../services/organigramaService');
...
controller.list= async (req, res) =>{
    ...
    if(acces.modulo_agenda){
        const organigrama = await list();
        // const categoria = await categoria_empresa();
        // console.log('Muestro los datos del organigrama',organigrama)
